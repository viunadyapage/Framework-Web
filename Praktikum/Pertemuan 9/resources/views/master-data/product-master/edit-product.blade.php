                        ...
                        <form action="{{ route('product-update', $product->id) }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="information" name="information" rows="3"
                                    class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('information') border-red-500 @enderror">{{ old('information', $product->information) }}</textarea>
                                @error('information')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="qty" name="qty" value="{{ old('qty', $product->qty) }}" min="0" step="1"
